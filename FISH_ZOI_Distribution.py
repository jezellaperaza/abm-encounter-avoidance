...
def main():
    ...
    for _ in range(num_simulations):
        fish_in_zoi_counts = run_simulation()
        total_fish_count = World.NUM_FISHES
        fish_probs = [count / total_fish_count for count in fish_in_zoi_counts]
        fish_counts.extend(fish_probs)  # combine probabilities from all simulations

    # histogram of fish probabilities within the zone of influence for all simulations
