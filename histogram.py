...
# fish_occurrence_histogram(zoi_fish_counts_500, "Probabilities of being in the Zone of Influence (500 runs)")
# fish_occurrence_histogram(ent_fish_counts_500, "Probabilities of being Entrained (500 runs)")
# fish_occurrence_histogram(collide_fish_counts_500, "Probabilities of Collision (500 runs)")
# fish_occurrence_histogram(strike_fish_counts_500, "Probabilities of Blade Strike (500 runs)")
# fish_occurrence_histogram(collide_strike_fish_counts_500, "Probabilities of Collision and Blade Strike (500 runs)")
...
# fish_occurrence_histogram(zoi_fish_counts_1000, "Probabilities of being in the Zone of Influence (1000 runs)")
# fish_occurrence_histogram(ent_fish_counts_1000, "Probabilities of being Entrained (1000 runs)")
# fish_occurrence_histogram(collide_fish_counts_1000, "Probabilities of Collision (1000 runs)")
# fish_occurrence_histogram(strike_fish_counts_1000, "Probabilities of Blade Strike (1000 runs)")
# fish_occurrence_histogram(collide_strike_fish_counts_1000, "Probabilities of Collision and Blade Strike (1000 runs)")
